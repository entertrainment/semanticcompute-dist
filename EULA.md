# SemanticCompute Binary Licence — DRAFT TEMPLATE (not legal advice)

> ⚠️ **This is a starting-point template, not final legal text.** Have a qualified solicitor
> review and adapt it before you rely on it commercially. It reuses the trial-then-paid intent
> from your existing `PRICING.md` but in a *proprietary binary* form (no source rights), which
> replaces BSL 1.1 for the distributed binaries. (Versions you already published under BSL 1.1
> remain under BSL 1.1 for their recipients — this governs the new binary artefacts only.)

**Licensor:** Douglas Horner, trading as Entertrainment (sole trader). **Product:** the
...
4. **No source rights.** No rights to the source code are granted. Source review may be offered
   separately under a mutual NDA / escrow at Licensor's discretion.
5. **Evidence, not certification.** The Product produces reproducible numerical evidence. It is
   **not** a certification, and confers no regulatory or safety approval. You remain responsible
   for your own validation and compliance.
6. **No warranty.** The Product is provided "as is", without warranty of any kind to the extent
   permitted by law. **Limitation of liability:** to the extent permitted by law, Licensor's
