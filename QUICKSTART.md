...
where you have a higher-precision reference, measure how *accurate* it is. You run a signed
binary; the source stays closed. Verification is the product — it is deliberately narrow
