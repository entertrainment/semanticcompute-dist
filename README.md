...
This is the **public distribution** repo: signed binaries, docs, and the licence. The source is
closed (commercial licence; source review under NDA).

- **Download:** the MCP server (`.mcpb`) + CLI binaries are on the [Releases](../../releases) page.
